          ...
          <Form onSubmit={this.handleSubmit}>
            <Row>
              ...
              <Col sm="8" style={{ padding: 25, backgroundColor: "#fff", borderRadius: 5, border: "1px solid rgba(0,0,0,0.4)", boxShadow: "0px 0px 5px 1px rgba(0,0,0,0.3)" }}>
                <Row>
                  <Col sm="12">
                    <h4 style={{ textAlign: "center", marginTop: 10 }}> Create Account </h4> <span style={{ color: "rgb(243, 83, 83)" }}> {this.state.errorMsg} </span>
                  </Col>
                  <Col>
                  ...
                  <Col sm="12">
                    <Row>
                      <Col sm="4">
                        <Button style={{ margin: 8 }} color="link" onClick={this.handleLogin} type="submit"> Login </Button>
                      </Col>
                      <Col sm="4"></Col>
                      <Col sm="4">
